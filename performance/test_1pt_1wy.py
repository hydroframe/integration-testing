...
def _write_log(request, duration):
    ...
    hydrodata_url = os.getenv("hydrodata_url", "https://hydrogen.princeton.edu").replace("https://", "")
    if server != "remote":
        hydrodata_url = ""
...
def _execute_scenario(start_time_str, end_time_str):
    ...
    options = {"dataset":"CW3E", "period":"hourly", "variable":"precipitation","start_time":start_time_str, "end_time":end_time_str, "grid_bounds":bounds, "nomask": "true"}
