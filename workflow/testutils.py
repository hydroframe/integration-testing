"""
   ...
   Several of these functions come from the ParFlow repo
   and are commonly used for testing ParFlow outputs against 
   each other.
"""
# pylint: disable=W0632,W0718
...
def pf_test_msig_diff(data, correct_data, message, sig_digits=6):
    """Wrapper around msig_diff function to produce boolean response.
